...
import { createContext, useEffect, useState } from "react";
import { jwtDecode } from "jwt-decode"; // You need to install jwt-decode library if you haven't already
import api from "../services/api";
...
export const AuthProvider = ({ children }) => {
  const [user, setUser] = useState(null);
  const [loading, setLoading] = useState(true); // Loading state to show while checking the token
